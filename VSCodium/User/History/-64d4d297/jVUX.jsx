...
import { login, selectToken } from "../../redux/reducers/auth/userReducer";
...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (experience !== '') {
                addExperiences(experience, newErrors);
            }
    ...
    const addExperiences = async (experiences, newErrors) => {
        const lines = experiences.split('\n');

        console.log(lines);

        const processedData = lines.map(l => {
        ...
        try {
            const result = await addExperience(processedData, token).unwrap();
