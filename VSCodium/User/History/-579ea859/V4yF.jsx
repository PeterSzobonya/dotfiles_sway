...
function EmployerProfile() {
    ...
    const salaryTo = '';
    const company = '';
    const { data, refetch } = useGetJobsQuery({ userId, salaryFrom, salaryTo, company, token }, { refetchOnMountOrArgChange: true, skip: false });
    ...
    const goToCreate = () => {
        navigate("/create-job-listing", {replace: true})
    }
    ...
    return (
        <>
            ...
            <Button variant="contained" onClick={goToCreate}>Hirdetés hozáadása</Button>
