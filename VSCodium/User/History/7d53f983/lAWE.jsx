...
import { useGetExperiencesMutation, useGetExperiencesQuery } from "../../redux/reducers/experience/experienceReducerApi";
...
function Login() {
  ...
  const [experienceQuery] = useGetExperiencesQuery();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const resultExperiences = await experienceQuery(token).unwrap();
      console.log(resultExperiences);
